...
var ghari;
var poke = new Image();
poke.src = '../hacker+/Dream_Fast_Ball_Sprite.png';
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function run2() {
    ...
    if (doop == true) {
        ...
        tara(canvas.width/2, niche(-1000), 7, 10, 15, -18, '#0353A4', 'white', 3);
        tara(canvas.width/2, niche(-1600), 7, 10, 15, -18, '#0353A4', 'white', 3);
        tara(canvas.width/2, niche(y - 950 - 8 * 400), 7, 10, 15, -18, '#0353A4', 'white', 3);
        tara(canvas.width/2, niche(y - 950 - 10 * 400), 7, 10, 15, -18, '#0353A4', 'white', 3);
        tara(canvas.width/2, niche(y - 950 - 18 * 400), 7, 10, 15, -18, '#0353A4', 'white', 3);
        tara(canvas.width/2, niche(y - 950 - 15 * 400), 7, 10, 15, -18, '#0353A4', 'white', 3);
        tara(canvas.width/2, niche(y - 950 - 26 * 400), 7, 10, 15, -18, '#0353A4', 'white', 3);
        tara(canvas.width/2, niche(y - 950 - 29 * 400), 7, 10, 15, -18, '#0353A4', 'white', 3);
        createobstacle_();
        kudo();   
        ...
        ctx2.fillText('High Score: ' + polar, 400, 60);
        ...
        ctx2.fillText('Click Uparrow to refresh high score', 60, 500);
...
function kudo() {
    ...
    if (gend.y_coordinate < 300) {
        monitor -= -1.5;
    }
    gend.y_coordinate += downward - upward;
    upward -= 0.3;
    if (gend.y_coordinate + gend.r > 627 && land == false) {
        lockdown();
    }

    if ((gend.y_coordinate  < niche(-1000)  && gend.y_coordinate > niche(-1600))|| (goal < 11 && goal > 8 )|| (goal < 19 && goal > 15 ) || (goal < 30 && goal > 26 ) )  {
        gend.villa = false;
        ctx2.drawImage(poke, gend.x_coordinate-15, gend.y_coordinate-15);
        ctx2.fillStyle = "white";
...
function createobstacle_() {
    ...
    for (x = block; x < obstacle.length; x++) {
        ...
        if (gend.y_coordinate + 6 < niche(obstacle[x].yo) + 6 && gend.y_coordinate > niche(obstacle[x].yo) - 6 && obstacle[x].exam == true) {
            goal++;
...
class circles2 {
    ...
    create(i) {
        ...
        for (var i = 0; i < 40; i++) {
            xx = 100 * Math.cos(this.rot * (Math.PI / 180)) + this.x_coordinate;
            ...
            ctx2.beginPath();
            ctx2.arc(xx, yy, 6, Math.PI / 180 * 0, Math.PI / 180 * 360, true);
            ctx2.closePath();
            ctx2.fillStyle = rang;
            ctx2.fill();
            ...
            if (xx - 6 <= gend.x_coordinate + 6 && xx + 6 >= gend.x_coordinate - 6 && yy - 6 <= gend.y_coordinate + 6 && yy + 6 >= gend.y_coordinate - 6 && gend.villa == true) {
                if (gend.rang != rang) {
                    lockdown();
                }
            }
    ...
    remove(i) {
        if (niche(this.yo - 100) > canvas.height) {
            obstacle.splice(i, 1);
            obstacle.push(new circles2(canvas.width / 2, this.yo - 1600, 0, 0.02 + this.theta + 0.00025, true, true));
        }
    }
}
...
class pipes2 {
    ...
    create(i) {
        ...
        if (((gend.x_coordinate - 6 <= this.x_coordinate - canvas.width/4.25 && gend.x_coordinate + 6 >= this.x_coordinate - canvas.width/4 && gend.y_coordinate - 6 <= niche(this.yo) + 50 && gend.y_coordinate >= niche(this.yo) - 50 && gend.rang != this.rang3) ||
            (gend.x_coordinate - 6 <= this.x_coordinate - canvas.width/9.09 && gend.x_coordinate + 6 >= this.x_coordinate - canvas.width/8 && gend.y_coordinate - 6 <= niche(this.yo) + 40 && gend.y_coordinate >= niche(this.yo) - 40 && gend.rang != this.rang1) ||
            (gend.x_coordinate - 6 <= this.x_coordinate + canvas.width/3.77 && gend.x_coordinate + 6 >= this.x_coordinate + canvas.width/4 && gend.y_coordinate - 6 <= niche(this.yo) + 70 && gend.y_coordinate >= niche(this.yo) - 70 && gend.rang != this.rang3) ||
            (gend.x_coordinate - 6 <= this.x_coordinate + canvas.width/7.14 && gend.x_coordinate + 6 >= this.x_coordinate + canvas.width/8 && gend.y_coordinate - 6 <= niche(this.yo) + 50 && gend.y_coordinate >= niche(this.yo) - 50 && gend.rang != this.rang2) ||
            (gend.x_coordinate - 6 <= this.x_coordinate + canvas.width/133.3 && gend.x_coordinate + 6 >= this.x_coordinate - canvas.width/133.3 && gend.y_coordinate - 6 <= niche(this.yo) + 70 && gend.y_coordinate >= niche(this.yo) - 70 && gend.rang != this.rang1))&& gend.villa == true) {
            lockdown();
        }
    }
    remove(i) {
...
class hpipes2 {
    ...
    create(i) {
        ...
        if (((gend.x_coordinate - 6 <= this.x_coordinate + canvas.width/8 && gend.x_coordinate + 6 >= this.x_coordinate - canvas.width/8 && gend.y_coordinate - 6 <= niche(this.yo) + 10 && gend.y_coordinate + 6 >= niche(this.yo) - 10 && gend.rang != this.rang1) ||
            (gend.x_coordinate - 6 <= this.x_coordinate + canvas.width/8 && gend.x_coordinate + 6 >= this.x_coordinate - canvas.width/8 && gend.y_coordinate - 6 <= niche(this.yo) + 80 && gend.y_coordinate + 6 >= niche(this.yo) + 60 && gend.rang != this.rang2) ||
            (gend.x_coordinate - 6 <= this.x_coordinate + canvas.width/8 && gend.x_coordinate + 6 >= this.x_coordinate - canvas.width/8 && gend.y_coordinate - 6 <= niche(this.yo) - 60 && gend.y_coordinate + 6 >= niche(this.yo) - 80 && gend.rang != this.rang4))&& gend.villa == true) {
            lockdown();
        }
    }
    remove(i) {
...
class dcircles2 {
    ...
    create(i) {
        ...
        for (var i = 0; i < 40; i++) {
            xx = 70 * Math.cos(this.rot * (Math.PI / 180)) + this.x_coordinate - 73;
            yy = 70 * Math.sin(this.rot * (Math.PI / 180)) + niche(this.yo);
            if (i < 10) {
                rang = '#F8333C';
            } else if (i >= 10 && i < 20) {
                rang = '#FCAB10';
            ...
            if (xx - 6 <= gend.x_coordinate + 6 && xx + 6 >= gend.x_coordinate - 6 && yy - 6 <= gend.y_coordinate + 6 && yy + 6 >= gend.y_coordinate - 6 && gend.rang != rang && gend.villa == true){
                lockdown();
            }
        }
    }
    remove(i) {
        if (niche(this.yo - 100) > canvas.height) {
            obstacle.splice(i, 1);
            obstacle.push(new dcircles2(canvas.width / 2, this.yo - 1600, 0, 0.02 + this.theta + 0.00025, true, true));
        }
    }
}
